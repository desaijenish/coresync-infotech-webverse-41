...
const Hero: React.FC<HeroProps> = ({ onContactClick }) => {
  const services = [
    {
      ...
      description: "Automate workflows with intelligent solutions that transform your business operations and boost productivity.",
      illustration: (
        <svg viewBox="0 0 400 400" className="w-full h-full" fill="currentColor">
          ...
          <circle cx="200" cy="200" r="150" fill="url(#ai-grad)" opacity="0.1" />
          <rect x="150" y="150" width="100" height="100" rx="10" fill="url(#ai-grad)" opacity="0.3" />
          <circle cx="175" cy="175" r="8" fill="url(#ai-grad)" />
          <circle cx="225" cy="175" r="8" fill="url(#ai-grad)" />
          <path d="M160 210 Q200 240 240 210" stroke="url(#ai-grad)" strokeWidth="4" fill="none" />
          <rect x="120" y="260" width="160" height="20" rx="10" fill="url(#ai-grad)" opacity="0.6" />
          <rect x="140" y="290" width="120" height="15" rx="8" fill="url(#ai-grad)" opacity="0.4" />
        </svg>
      )
    },
    {
      title: "Game Development",
      description: "Create immersive gaming experiences across all platforms with cutting-edge engines and frameworks.",
      illustration: (
        <svg viewBox="0 0 400 400" className="w-full h-full" fill="currentColor">
          <defs>
          ...
          <circle cx="200" cy="200" r="150" fill="url(#game-grad)" opacity="0.1" />
          <rect x="120" y="160" width="160" height="80" rx="40" fill="url(#game-grad)" opacity="0.3" />
    ...
    },
    {
      ...
      description: "Build modern, responsive websites and web applications with the latest technologies and best practices.",
      illustration: (
        <svg viewBox="0 0 400 400" className="w-full h-full" fill="currentColor">
          <defs>
          ...
          <circle cx="200" cy="200" r="150" fill="url(#web-grad)" opacity="0.1" />
          <rect x="120" y="140" width="160" height="120" rx="8" fill="url(#web-grad)" opacity="0.3" />
          <rect x="130" y="150" width="140" height="20" fill="url(#web-grad)" opacity="0.6" />
          ...
          <rect x="140" y="180" width="60" height="8" fill="url(#web-grad)" opacity="0.5" />
          <rect x="140" y="200" width="40" height="8" fill="url(#web-grad)" opacity="0.4" />
          <rect x="140" y="220" width="80" height="8" fill="url(#web-grad)" opacity="0.3" />
        </svg>
      )
    },
    {
      title: "Mobile App Development",
      description: "Develop native and cross-platform mobile applications with seamless user experiences for iOS and Android.",
      illustration: (
        <svg viewBox="0 0 400 400" className="w-full h-full" fill="currentColor">
          <defs>
          ...
          <circle cx="200" cy="200" r="150" fill="url(#mobile-grad)" opacity="0.1" />
          <rect x="160" y="120" width="80" height="160" rx="12" fill="url(#mobile-grad)" opacity="0.3" />
          <rect x="170" y="140" width="60" height="80" fill="url(#mobile-grad)" opacity="0.5" />
          <circle cx="200" cy="250" r="8" fill="url(#mobile-grad)" />
          <rect x="190" y="130" width="20" height="4" rx="2" fill="url(#mobile-grad)" opacity="0.7" />
          <rect x="180" y="150" width="40" height="6" fill="url(#mobile-grad)" opacity="0.4" />
          <rect x="180" y="170" width="30" height="6" fill="url(#mobile-grad)" opacity="0.4" />
          <rect x="180" y="190" width="35" height="6" fill="url(#mobile-grad)" opacity="0.4" />
        </svg>
      )
    },
    {
      title: "Animation & Video Editing",
      description: "Create stunning animations, motion graphics, and video content that brings your brand vision to life.",
      illustration: (
        <svg viewBox="0 0 400 400" className="w-full h-full" fill="currentColor">
          <defs>
          ...
          <circle cx="200" cy="200" r="150" fill="url(#video-grad)" opacity="0.1" />
          <rect x="140" y="160" width="120" height="80" rx="8" fill="url(#video-grad)" opacity="0.3" />
          <polygon points="180,190 180,210 210,200" fill="url(#video-grad)" />
          <rect x="150" y="250" width="20" height="10" fill="url(#video-grad)" opacity="0.6" />
          <rect x="180" y="250" width="15" height="10" fill="url(#video-grad)" opacity="0.5" />
          <rect x="205" y="250" width="25" height="10" fill="url(#video-grad)" opacity="0.7" />
          <rect x="240" y="250" width="10" height="10" fill="url(#video-grad)" opacity="0.4" />
        </svg>
      )
    }
  ];
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 bg-gradient-to-br from-background to-muted/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-5 hidden lg:block" viewBox="0 0 1920 1080">
          <defs>
          ...
          <line x1="100" y1="100" x2="300" y2="200" stroke="url(#line-grad)" strokeWidth="1" className="animate-pulse" />
          <line x1="300" y1="200" x2="500" y2="150" stroke="url(#line-grad)" strokeWidth="1" className="animate-pulse" />
          <line x1="500" y1="150" x2="700" y2="300" stroke="url(#line-grad)" strokeWidth="1" className="animate-pulse" />
          <circle cx="100" cy="100" r="3" fill="#EC6E00" className="animate-pulse" />
          <circle cx="300" cy="200" r="3" fill="#4592FF" className="animate-pulse" />
          <circle cx="500" cy="150" r="3" fill="#EC6E00" className="animate-pulse" />
          <circle cx="700" cy="300" r="3" fill="#4592FF" className="animate-pulse" />
        </svg>
      </div>
