...
const Navbar = () => {
  ...
  const serviceCategories: ServiceCategories = {
    'Mobile App Development': ['Android', 'iOS', 'Flutter', 'React Native', 'Ionic'],
    'Web Development': ['React.js', 'Next.js', 'Vite', 'Tailwind', 'JavaScript', 'TypeScript'],
    'Computer Software': ['AI/ML Solutions', 'ERP Systems', 'CRM Software', 'Business Analytics'],
    'Animation & Video Editing': ['2D Animation', '3D Animation', 'Motion Graphics', 'Video Production'],
    'Game Development': ['Unity', 'Unreal Engine', 'Mobile Games', 'PC Games', '2D/3D Games']
  };
