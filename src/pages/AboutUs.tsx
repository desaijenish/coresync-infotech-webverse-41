...
const AboutUs = () => {
  const principles = [
    ...
    },
    {
      ...
      title: "Promise",
      content:
        "We promise to be your trusted technology partner, delivering solutions that not only meet your current needs but also scale with your future ambitions and goals.",
                ...
                >
                  <Card className="relative h-full overflow-hidden bg-card/50 backdrop-blur-sm border-2 border-transparent hover:border-Coresyncro-primary-light/30 transition-all duration-500">
                    <CardContent className="p-6 text-center space-y-4 relative z-10">
                      {/* Icon */}
                      <div
                        className={`w-16 h-16 mx-auto rounded-full bg-gradient-to-r ${principle.gradient} p-4 mb-4 group-hover:scale-110 transition-transform duration-300`}
                      >
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${principle.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
                    ></div>

                    {/* Glow effect */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${principle.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-xl -z-10`}
                    ></div>
                  </Card>
                </motion.div>
              ))}
